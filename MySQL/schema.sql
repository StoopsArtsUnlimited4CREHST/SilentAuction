...
GRANT ALL ON *.* TO 'root' IDENTIFIED BY 'auction' WITH GRANT OPTION;
GRANT ALL ON *.* TO 'auction'@localhost IDENTIFIED BY 'auction' WITH GRANT OPTION;
GRANT ALL ON *.* TO 'auction' IDENTIFIED BY 'auction' WITH GRANT OPTION;
