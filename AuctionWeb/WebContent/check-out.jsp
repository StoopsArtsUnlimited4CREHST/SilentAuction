...
<!-- end #header --></div>
  <div id="mainContent"><!-- InstanceBeginEditable name="Body" -->
    <p>Select a bidder<br />
      Inform bidder of won lots, bids, and total amount<br />
      How to handle questions/disputes?<br />
      Take and record payment<br />
    Print statement of account</p>
  <!-- InstanceEndEditable -->
  <!-- end #mainContent --></div>
  <div id="footer">
    <p>Footer</p>
